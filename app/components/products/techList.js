...
export const products = [
    {
      title: 'Product Strategy & Vision Consulting',
    ...
    {
      title: 'Product Requirements Development (PRD) Services',
      description: 'Develop comprehensive Product Requirement Documents that capture the functional and non-functional needs of your product.',
    },
    {
